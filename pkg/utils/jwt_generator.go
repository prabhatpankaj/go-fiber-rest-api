...
func GenerateNewTokens(id string, rolejson []models.Role) (*Tokens, error) {
	// Generate JWT Access token.
	accessToken, err := generateNewAccessToken(id, rolejson)
	if err != nil {
...
func generateNewAccessToken(id string, rolejson []models.Role) (string, error) {
